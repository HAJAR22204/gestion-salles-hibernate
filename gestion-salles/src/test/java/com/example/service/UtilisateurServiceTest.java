...
public class UtilisateurServiceTest {
    ...
    public void testCrudOperations() {
        ...
        utilisateur.setTelephone("+33699945678");
    ...
    public void testFindByEmail() {
        // Create test user
        Utilisateur utilisateur = new Utilisateur("Email", "Test", "email.test@gmail.com");
        service.save(utilisateur);

        // Test find by email
        Optional<Utilisateur> foundUtilisateur = service.findByEmail("email.test@gmail.com");
        assertTrue(foundUtilisateur.isPresent());
    ...
    public void testFindAll() {
        // Create test users
        Utilisateur u1 = new Utilisateur("User", "One", "user.one@gmail.com");
        Utilisateur u2 = new Utilisateur("User", "Two", "user.two@gmail.com");
        service.save(u1);
        service.save(u2);
